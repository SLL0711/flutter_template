import 'package:flutter_medical_beauty/im/chat/chat_items/chat_file_bubble.dart';
import 'package:flutter_medical_beauty/im/chat/chat_items/chat_image_bubble.dart';
import 'package:flutter_medical_beauty/im/chat/chat_items/chat_location_bubble.dart';
import 'package:flutter_medical_beauty/im/chat/chat_items/chat_text_bubble.dart';
import 'package:flutter_medical_beauty/im/chat/chat_items/chat_video_bubble.dart';
import 'package:flutter_medical_beauty/im/chat/chat_items/chat_voice_bubble.dart';
          ...
          bubble = Builder(builder: (context) {
            return Selector(
              ...
              builder: (_, data, __) => ChatVoiceBubble(
                ...
                isSend,
                ((data as dynamic).item1 == widget.msg.msgId) &&
                    (data as dynamic).item2,
              ),
            );
          });
          break;
