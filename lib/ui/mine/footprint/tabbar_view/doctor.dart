...
class FootprintDoctorScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => FootprintDoctorScreenState();
}

class FootprintDoctorScreenState extends State<FootprintDoctorScreen>
      ...
      child: _itemEntityList.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                // if (index == 0 || index == 3) {
                //   return FootprintWidgets.listHeaderItem(context, index != 0, isDoctor: true);
                // }
                return GestureDetector(
                  behavior: HitTestBehavior.opaque,
                  onTap: () {
                    NavigatorUtil.pushPage(
                        context, DoctorDetailScreen(_itemEntityList[index].id));
                  },
