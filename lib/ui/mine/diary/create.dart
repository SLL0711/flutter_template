...
class DiaryCreateScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => DiaryCreateScreenState();
}

class DiaryCreateScreenState extends State<DiaryCreateScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CityWidgets.cityAppBar(context, '新建日记本', () {
