...
class PayMemberScreen extends StatefulWidget {
  final OpenMemberEntity entity;

  PayMemberScreen(this.entity);

  @override
  State<StatefulWidget> createState() => PayMemberScreenState();
}

class PayMemberScreenState extends State<PayMemberScreen>
  ...
  void initState() {
    ...
    fluwx.weChatResponseEventHandler.listen((res) {
      if (res is fluwx.WeChatPaymentResponse) {
        debugPrint("pay :${res.isSuccessful}");
        if (res.isSuccessful) {
          ToastHud.show(context, "支付成功");
          EventCenter.defaultCenter().fire(RefreshMineEvent('buyMember'));
        ...
        setState(
          () {
            if (_countdownTime < 1) {
              ...
              _countText =
                  '支付剩余时间${minutes.toString().split('.').first}:$seconds';
            }
          },
        );
      },
  ...
  void _alipay(String payType) async {
    ...
    if (result) {
      ...
      params['source'] = '2';
      params['sourceId'] = widget.entity.sourceId.toString();
      params['totalAmount'] = widget.entity.payPrice.toString();
  ...
  Widget build(BuildContext context) {
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        title,
                        style: TextStyle(
                            fontSize: 20, color: XCColors.mainTextColor),
                      ),
                      SizedBox(width: 10),
                      Container(
                        width: 20,
            ...
            children: [
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                        text: widget.entity.payPrice.toString(),
                        style: TextStyle(
                            fontSize: 36,
                            fontWeight: FontWeight.bold,
                            color: XCColors.mainTextColor))
    ...
    return Scaffold(
        ...
        appBar: CityWidgets.cityAppBar(context, '立即开卡', () {
