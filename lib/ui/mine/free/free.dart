...
import 'package:flutter_medical_beauty/ui/mine/free/category.dart';

class FreeScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => FreeScreenState();
}
...
class FreeScreenState extends State<FreeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CityWidgets.cityAppBar(context, '会员券', () {
            ...
            Expanded(
              child: TabBarView(
                children: List<Widget>.generate(
                  _tabItems.length,
                  (index) {
                    return FreeCategoryScreen(index);
                  },
                ),
              ),
            ),
