...
class CreateAddressScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CreateAddressScreenState();
}
...
class CreateAddressScreenState extends State<CreateAddressScreen>
  ...
  void _saveInfo() async {
    ...
    var http = await HttpManager.post(DsApi.addressAdd, params, context);
    ToastHud.dismiss();
    if (http.code == 200) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: CityWidgets.cityAppBar(context, '新增地址', () {
