...
class PraiseTabBarView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PraiseTabBarViewState();
}

class PraiseTabBarViewState extends State<PraiseTabBarView>
    with AutomaticKeepAliveClientMixin {
  /// tab类别
  List<String> _tabItems = ['商品', '日记', '问答'];
