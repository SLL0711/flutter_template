                ...
                child: GestureDetector(
                    ...
                    child: Container(
                        ...
                        child: Column(children: [
                          Container(
                              height: 1, color: XCColors.homeScreeningColor),
                          Expanded(
                              child: Row(children: [
                                Container(
                                    width: 120,
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return GestureDetector(
                                        ...
                                        onTap: () {
                                          ...
                                          entity.isSelected = true;
                                          screeningParams
                                              .distanceFilterType = 2;
                                          if (index == 0) {
                                            screeningParams
                                                .distanceFilterType = 1;
                                          } else if (index == 1) {
                                            screeningParams.minDistance = 0;
                                            screeningParams.maxDistance = 5;
                                          } else if (index == 2) {
                                            screeningParams.minDistance = 5;
                                            screeningParams.maxDistance =
                                            10;
                                          } else if (index == 3) {
                                            screeningParams.minDistance =
                                            10;
                                            screeningParams.maxDistance =
                                            10000;
                                          }
