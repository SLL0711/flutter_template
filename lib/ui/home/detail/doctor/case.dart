...
class DoctorCaseView extends StatefulWidget {
  final int doctorId;

  DoctorCaseView(this.doctorId);

  @override
  State<StatefulWidget> createState() => DoctorCaseViewState();
}

class DoctorCaseViewState extends State<DoctorCaseView>
