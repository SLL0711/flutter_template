...
class DoctorSubscribeView extends StatefulWidget {
  final int doctorId;

  DoctorSubscribeView(this.doctorId);

  @override
  State<StatefulWidget> createState() => DoctorSubscribeViewState();
}

class DoctorSubscribeViewState extends State<DoctorSubscribeView>
