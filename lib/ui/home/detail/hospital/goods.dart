...
class OrgGoodsView extends StatefulWidget {
  final int id;

  OrgGoodsView(this.id);

  @override
  State<StatefulWidget> createState() => OrgGoodsViewState();
}

class OrgGoodsViewState extends State<OrgGoodsView>
    ...
    if (http.code == 200) {
      ...
      setState(() {
        http.data.forEach((element) {
          ProductItemEntity entity = ProductItemEntity.fromJson(element);
