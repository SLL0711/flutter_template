...
class OrderPayScreen extends StatefulWidget {
  ...
  OrderPayScreen(this.orderId, {this.source = 0});

  @override
  State<StatefulWidget> createState() => OrderPayScreenState();
}

class OrderPayScreenState extends State<OrderPayScreen>
  ...
  void _countdown() {
    if (_order.paymentExpirationTime == '') {
      return;
    }
    int expiration =
